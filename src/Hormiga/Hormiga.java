...
public class Hormiga {
    ...
    public static void main(String[] args) {
        ArrayList<DatosHormiga> listaHormigas = new ArrayList<>();
        ...
        for (int i = 0; i < 20; i++) {
            ...
            switch (indiceAleatorio) {
                case 0:
                    ...
                    Hormiguita = new DatosHormiga(codigo, numserieunica, elementoAleatorio);
                ...
                case 2:
                System.out.println(elementoAleatorio);
                    Hormiguita = new DatosHormiga(codigo, elementoAleatorio);
                    break;
                case 3:
                System.out.println(elementoAleatorio);
                    Hormiguita = new DatosHormiga(codigo, elementoAleatorio);
